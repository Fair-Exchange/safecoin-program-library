...
impl NativeTokenSwap {
    pub fn new(
        ...
        let mut pool_token_program_account = create_program_account(safe_token::id());
        let token_a_program_account = create_program_account(safe_token::id());
        let token_b_program_account = create_program_account(safe_token::id());
