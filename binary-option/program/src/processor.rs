use crate::{
    ...
    spl_utils::{
        ...
        spl_set_authority, safe_token_transfer, safe_token_transfer_signed,
    },
    state::BinaryOption,
...
pub fn process_initialize_binary_option(
    ...
    assert_keys_equal(*token_program_info.key, safe_token::id())?;
...
pub fn process_trade(
    ...
    assert_keys_equal(*long_token_mint_info.owner, safe_token::id())?;
    assert_keys_equal(*short_token_mint_info.owner, safe_token::id())?;
...
pub fn process_collect(program_id: &Pubkey, accounts: &[AccountInfo]) -> ProgramResult {
    ...
    assert_owned_by(long_token_mint_info, &safe_token::id())?;
    assert_owned_by(short_token_mint_info, &safe_token::id())?;
