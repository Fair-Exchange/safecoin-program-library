...
use {
    ...
    safecoin_sdk::{instruction::Instruction, pubkey::Pubkey, system_instruction},
...
impl FarmClient {
    ...
    pub fn new_instruction_transfer(
        ...
        Ok(system_instruction::transfer(
            wallet_address,
            destination_wallet,
            self.ui_amount_to_tokens_with_decimals(sol_ui_amount, safe_token::native_mint::DECIMALS),
        ))
    }
