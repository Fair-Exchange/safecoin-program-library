...
impl Config {
    pub fn new(matches: &ArgMatches) -> Self {
        let cli_config = if let Some(config_file) = matches.value_of("config_file") {
            match safecoin_cli_config::Config::load(config_file) {
                Err(e) => {
    ...
    App::new(crate_name!())
        ...
        .subcommand(
            SubCommand::with_name("transfer")
                .about("Transfer SAFE to another wallet")
                .arg(wallet.clone())
                .arg(amount.clone()),
        )
        .subcommand(
        ...
        .subcommand(
            SubCommand::with_name("wrap-sol")
                .about("Transfer SAFE to the associated WSAFE account")
                .arg(amount.clone()),
        )
        .subcommand(
            SubCommand::with_name("unwrap-sol")
                .about("Transfer WSAFE back to SAFE by closing ATA")
        )
        .subcommand(
        ...
        .subcommand(SubCommand::with_name("balance").about("Print SAFE balance"))
        .subcommand(
