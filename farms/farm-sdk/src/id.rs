...
pub mod main_router {
    safecoin_program::declare_id!("RepLaceThisWithVaLidMainRouterProgramPubkey");
}

pub mod main_router_admin {
    safecoin_program::declare_id!("RepLaceThisWithCorrectMainRouterAdminPubkey");
}
...
pub mod zero {
    ...
    safecoin_program::declare_id!("zeRosMEYuuABXv5y2LNUbgmPp62yFD5CULW5soHS9HR");
}
