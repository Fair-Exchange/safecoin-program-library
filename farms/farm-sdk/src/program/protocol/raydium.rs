...
pub mod raydium_v2 {
    safecoin_program::declare_id!("RAYFrn8s4Bsx7NY6gXQPpnWax5dDgd3MCayubNVcZvd");
}
pub mod raydium_v3 {
    safecoin_program::declare_id!("RAYFZ91CAQSREwhzPVssQM6w33uYPfKM5Nea6o4mH1t");
}
pub mod raydium_v4 {
    safecoin_program::declare_id!("675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8");
}
pub mod raydium_stake {
    safecoin_program::declare_id!("RAYqdf1KnhLXkfvhvxQXajuRY2Gq3pHvv3Ucr7WwM6t");
}
pub mod raydium_stake_v4 {
    safecoin_program::declare_id!("CBuCnLe26faBpcBP2fktp4rp8abpcAnTWft6ZrP5Q4T");
}
pub mod raydium_stake_v5 {
    safecoin_program::declare_id!("9KEPoZmtHUrBbhWN1v1KWLMkkvwY6WLtAVUCPRtRjP4z");
}
...
pub fn add_liquidity(
    ...
    if let [user_account, user_token_a_account, user_token_b_account, user_lp_token_account, pool_program_id, pool_coin_token_account, pool_pc_token_account, lp_token_mint, safe_token_id, amm_id, amm_authority, amm_open_orders, amm_target, serum_market] =
        accounts
    {
...
pub fn add_liquidity_with_seeds(
    ...
    if let [authority_account, token_a_custody_account, token_b_custody_account, lp_token_custody_account, pool_program_id, pool_coin_token_account, pool_pc_token_account, lp_token_mint, safe_token_id, amm_id, amm_authority, amm_open_orders, amm_target, serum_market] =
        accounts
    {
        if !check_pool_program_id(pool_program_id.key) {
            return Err(ProgramError::IncorrectProgramId);
...
pub fn remove_liquidity_with_seeds(
    ...
    if let [authority_account, token_a_custody_account, token_b_custody_account, lp_token_custody_account, pool_program_id, pool_withdraw_queue, pool_temp_lp_token_account, pool_coin_token_account, pool_pc_token_account, lp_token_mint, safe_token_id, amm_id, amm_authority, amm_open_orders, amm_target, serum_market, serum_program_id, serum_bids, serum_asks, serum_event_queue, serum_coin_vault_account, serum_pc_vault_account, serum_vault_signer] =
        accounts
    {
        if !check_pool_program_id(pool_program_id.key) {
            return Err(ProgramError::IncorrectProgramId);
...
pub fn stake_with_seeds(
    ...
    if let [authority_account, stake_info_account, lp_token_custody_account, token_a_custody_account, token_b_custody_account, pool_program_id, farm_lp_token_account, farm_first_reward_token_account, farm_second_reward_token_account, clock_id, safe_token_id, farm_id, farm_authority] =
        accounts
    {
...
pub fn swap_with_seeds(
    ...
    if let [authority_account, token_a_custody_account, token_b_custody_account, pool_program_id, pool_coin_token_account, pool_pc_token_account, safe_token_id, amm_id, amm_authority, amm_open_orders, amm_target, serum_market, serum_program_id, serum_bids, serum_asks, serum_event_queue, serum_coin_vault_account, serum_pc_vault_account, serum_vault_signer] =
        accounts
    {
        if !check_pool_program_id(pool_program_id.key) {
            return Err(ProgramError::IncorrectProgramId);
