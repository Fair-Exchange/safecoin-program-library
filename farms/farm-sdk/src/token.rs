...
impl std::fmt::Display for TokenType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match *self {
            TokenType::NativeSafe => write!(f, "NativeSafe"),
            TokenType::WrappedSafe => write!(f, "WrappedSafe"),
            TokenType::WrappedSafelet => write!(f, "WrappedSafelet"),
            TokenType::WrappedWarmhole => write!(f, "WrappedWarmhole"),
            TokenType::SafeToken => write!(f, "SafeToken"),
