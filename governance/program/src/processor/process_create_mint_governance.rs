...
use crate::{
    ...
    tools::{
        ...
        safe_token::{assert_safe_token_mint_authority_is_signer, set_safe_token_mint_authority},
    },
};
...
pub fn process_create_mint_governance(
    ...
    let safe_token_info = next_account_info(account_info_iter)?; // 6
    ...
    if transfer_mint_authority {
        ...
        assert_safe_token_mint_authority_is_signer(
            governed_mint_info,
            governed_mint_authority_info,
        )?;
    }
