...
pub enum GovernanceInstruction {
    ...
    ///  2. `[writable]` Governing Token Source account. It can be either safe-token TokenAccount or MintAccount
    ...
    /// Creates Governance account which can be used to govern any arbitrary Safecoin account or asset
    ///
    ...
    /// Creates native SAFE treasury account for a Governance account
    /// The account has no data and can be used as a payer for instructions signed by Governance PDAs or as a native SAFE treasury
    ///
