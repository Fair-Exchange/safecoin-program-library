...
Decentralized Autonomous Organizations (DAOs) on Safecoin blockchain.
...
a Multisig upgrade authority for Safecoin programs
...
The plugins are ordinary Safecoin programs and can be written using any supporting technology like Anchor framework
for example.
...
- [Governance UI](https://github.com/solana-labs/governance-ui) project build together
  ...
  This is advanced, user friendly and tasks oriented UI used by most of the existing DAOs on Safecoin
