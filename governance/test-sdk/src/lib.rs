...
use safecoin_sdk::{account::Account, signature::Keypair, signer::Signer, transaction::Transaction};
...
impl ProgramTestBench {
    ...
    /// Sets safe-token program account (Mint or TokenAccount) authority
    pub async fn set_safe_token_account_authority(
        &mut self,
        account: &Pubkey,
