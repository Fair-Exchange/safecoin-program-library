...
async fn setup() -> (
    ...
    let mut program_test = ProgramTest::new(
        ...
        processor!(safe_token_upgrade::processor::process),
    );
...
#[test_case(safe_token::id(), safe_token_2022::id() ; "upgrade to token-2022")]
#[test_case(safe_token_2022::id(), safe_token::id() ; "downgrade to token")]
#[test_case(safe_token::id(), safe_token::id() ; "token to token")]
#[test_case(safe_token_2022::id(), safe_token_2022::id() ; "token-2022 to token-2022")]
#[tokio::test]
...
#[test_case(safe_token::id(), safe_token_2022::id() ; "fail upgrade to token-2022")]
#[tokio::test]
