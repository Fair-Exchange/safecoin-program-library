use {
    ...
    safe_associated_token_account::get_associated_token_address_with_program_id,
    safe_token_2022::{
    ...
    safe_token_upgrade::{get_token_upgrade_authority_address, instruction::exchange},
...
async fn process_create_escrow_account(
    ...
    let escrow_authority =
        get_token_upgrade_authority_address(original_mint, new_mint, &safe_token_upgrade::id());
        ...
        .subcommand(
            ...
            .arg(
                Arg::new("multisig_signer")
                    ...
                    .multiple(true)
                    .min_values(0)
                    .max_values(safe_token_2022::instruction::MAX_SIGNERS)
...
mod test {
    ...
    async fn new_validator_for_test() -> (TestValidator, Keypair) {
        ...
        test_validator_genesis.add_programs_with_path(&[
            ...
            ProgramInfo {
                program_id: safe_token_upgrade::id(),
                loader: bpf_loader::id(),
                program_path: PathBuf::from("../../target/deploy/safe_token_upgrade.so"),
            },
        ]);
