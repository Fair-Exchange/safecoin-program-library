...
pub fn process_recover_nested(program_id: &Pubkey, accounts: &[AccountInfo]) -> ProgramResult {
    ...
    if owner_token_mint_info.owner != safe_token_program_id {
    ...
    let (amount, decimals) = {
        ...
        if owner_associated_token_account_info.owner != safe_token_program_id {
        ...
        if nested_associated_token_account_info.owner != safe_token_program_id {
        ...
        if nested_token_mint_info.owner != safe_token_program_id {
