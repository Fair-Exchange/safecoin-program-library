...
use {
    ...
    safe_associated_token_account::{get_associated_token_address_with_program_id, instruction},
    safe_token_2022::{
...
async fn success_same_mint_2022() {
    ...
    check_same_mint(&mut context, &safe_token_2022::id()).await;
}
...
async fn success_same_mint() {
    ...
    let mut context = pt.start_with_context().await;
    check_same_mint(&mut context, &safe_token::id()).await;
}
...
async fn success_different_mints() {
    ...
    let pt = program_test(dummy_mint, true);
    let mut context = pt.start_with_context().await;
    check_different_mints(&mut context, &safe_token::id()).await;
}
...
async fn success_different_mints_2022() {
    ...
    let pt = program_test_2022(dummy_mint, true);
    let mut context = pt.start_with_context().await;
    check_different_mints(&mut context, &safe_token_2022::id()).await;
}
...
async fn fail_missing_wallet_signature_2022() {
    ...
    let pt = program_test_2022(dummy_mint, true);
    let mut context = pt.start_with_context().await;
    check_missing_wallet_signature(&mut context, &safe_token_2022::id()).await;
}
...
async fn fail_missing_wallet_signature() {
    ...
    let pt = program_test(dummy_mint, true);
    let mut context = pt.start_with_context().await;
    check_missing_wallet_signature(&mut context, &safe_token::id()).await;
}
...
async fn fail_wrong_signer_2022() {
    ...
    let pt = program_test_2022(dummy_mint, true);
    let mut context = pt.start_with_context().await;
    check_wrong_signer(&mut context, &safe_token_2022::id()).await;
}
...
async fn fail_wrong_signer() {
    ...
    let pt = program_test(dummy_mint, true);
    let mut context = pt.start_with_context().await;
    check_wrong_signer(&mut context, &safe_token::id()).await;
}
...
async fn fail_not_nested_2022() {
    ...
    let pt = program_test_2022(dummy_mint, true);
    let mut context = pt.start_with_context().await;
    check_not_nested(&mut context, &safe_token_2022::id()).await;
}
...
async fn fail_not_nested() {
    ...
    let pt = program_test(dummy_mint, true);
    let mut context = pt.start_with_context().await;
    check_not_nested(&mut context, &safe_token::id()).await;
}
...
async fn fail_wrong_address_derivation_owner_2022() {
    ...
    let pt = program_test_2022(dummy_mint, true);
    let mut context = pt.start_with_context().await;
    check_wrong_address_derivation_owner(&mut context, &safe_token_2022::id()).await;
}
...
async fn fail_wrong_address_derivation_owner() {
    ...
    let pt = program_test(dummy_mint, true);
    let mut context = pt.start_with_context().await;
    check_wrong_address_derivation_owner(&mut context, &safe_token::id()).await;
}
...
async fn fail_owner_account_does_not_exist() {
    ...
    let pt = program_test_2022(dummy_mint, true);
    let mut context = pt.start_with_context().await;
    check_owner_account_does_not_exist(&mut context, &safe_token_2022::id()).await;
}

#[tokio::test]
async fn fail_wrong_safe_token_program() {
    let wallet = Keypair::new();
    let dummy_mint = Pubkey::new_unique();
    let pt = program_test_2022(dummy_mint, true);
    let mut context = pt.start_with_context().await;
    let program_id = safe_token_2022::id();
    let wrong_program_id = safe_token::id();
