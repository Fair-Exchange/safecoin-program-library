...
use {
    ...
    safecoin_program::{instruction::*, pubkey::Pubkey, system_instruction, sysvar},
    ...
    safe_token_2022::{extension::ExtensionType, state::Account},
};
...
async fn test_associated_token_address() {
    ...
    assert_eq!(associated_account.owner, safe_token_2022::id());
