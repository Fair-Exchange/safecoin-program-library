import type { PublicKey, Connection } from "@safecoin/web3.js";
...
/**
 * These are all the fields needed to deserialize the safecoin account
...
const changeLogBeetFactory = (maxDepth: number) => {
  return new beet.BeetArgsStruct<ChangeLog>(
    [
      ['root', beetSafecoin.publicKey],
      ['pathNodes', beet.uniformFixedSizeArray(beetSafecoin.publicKey, maxDepth)],
      ['index', beet.u32],
      ["_padding", beet.u32],
    ],
    'ChangeLog'
