...
//!
//! To circumvent proof size restrictions stemming from Safecoin transaction size restrictions,
...
//! All modifications to SPL ConcurrentMerkleTrees are settled on the Safecoin ledger via instructions against the SPL Compression contract.
...
pub mod spl_account_compression {
    ...
    /// [here](https://github.com/fair-exchange/safecoin-program-library/tree/master/libraries/concurrent-merkle-tree)
