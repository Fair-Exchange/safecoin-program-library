...
```shell
npm install --save @solana/spl-account-compression @safecoin/web3.js
```

__OR__

```shell
yarn add @solana/spl-account-compression @safecoin/web3.js
```
...
* Safecoin Program Library [tests](https://github.com/fair-exchange/safecoin-program-library/tree/master/account-compression/sdk/tests)
