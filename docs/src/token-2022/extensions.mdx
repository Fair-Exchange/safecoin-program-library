...
[Token JS examples](https://github.com/fair-exchange/safecoin-program-library/tree/master/token/js/examples).
...
```console
$ safe-token --program-id ZToGWcF1Qh9H7te1MmABiGsFUKvj5zXPQ2QnTqoHpHN create-token --enable-close
Creating token C47NXhUTVEisCfX7s16KrxYyimnui7HpUXZecE2TmLdB under program ZToGWcF1Qh9H7te1MmABiGsFUKvj5zXPQ2QnTqoHpHN
```
...
```console
$ safe-token close-mint C47NXhUTVEisCfX7s16KrxYyimnui7HpUXZecE2TmLdB 
...
```console
$ safe-token --program-id ZToGWcF1Qh9H7te1MmABiGsFUKvj5zXPQ2QnTqoHpHN create-token --transfer-fee 50 5000
Creating token Dg3i18BN7vzsbAZDnDv3H8nQQjSaPUTqhwX41J7NZb5H under program ZToGWcF1Qh9H7te1MmABiGsFUKvj5zXPQ2QnTqoHpHN
...
```console
$ safe-token create-account Dg3i18BN7vzsbAZDnDv3H8nQQjSaPUTqhwX41J7NZb5H
...
$ safecoin-keygen new -o destination.json
$ safe-token create-account Dg3i18BN7vzsbAZDnDv3H8nQQjSaPUTqhwX41J7NZb5H destination.json
...
$ safe-token mint Dg3i18BN7vzsbAZDnDv3H8nQQjSaPUTqhwX41J7NZb5H 1000000000
...
$ safe-token transfer --expected-fee 0.000005 Dg3i18BN7vzsbAZDnDv3H8nQQjSaPUTqhwX41J7NZb5H 1000000 destination.json
...
```console
$ safe-token withdraw-withheld-tokens 7UKuG4W68hW9eGrDms6BenRf8DCEHKGN49xewtWyB5cx 5wY8fiMZG5wGbQmtzKgqqEEp4vsCMJZ53RXEagUUWhEr
...
```console
$ safe-token close --address 5wY8fiMZG5wGbQmtzKgqqEEp4vsCMJZ53RXEagUUWhEr
...
```console
$ safe-token withdraw-withheld-tokens --include-mint 7UKuG4W68hW9eGrDms6BenRf8DCEHKGN49xewtWyB5cx
...
```console
$ safe-token --program-id ZToGWcF1Qh9H7te1MmABiGsFUKvj5zXPQ2QnTqoHpHN create-token --enable-freeze --default-account-state frozen
Creating token 8Sqz2zV8TFTnkLtnCdqRkjJsre3GKRwHcZd3juE5jJHf under program ZToGWcF1Qh9H7te1MmABiGsFUKvj5zXPQ2QnTqoHpHN
...
$ safe-token create-account 8Sqz2zV8TFTnkLtnCdqRkjJsre3GKRwHcZd3juE5jJHf
...
$ safe-token display 6XpKagP1N3K1XnzStufpV5YZ6DksEkQWgLNG9kPpLyvv
SPL Token Account
  Address: 6XpKagP1N3K1XnzStufpV5YZ6DksEkQWgLNG9kPpLyvv
  Program: ZToGWcF1Qh9H7te1MmABiGsFUKvj5zXPQ2QnTqoHpHN
  Balance: 0
  Decimals: 9
...
```console
$ safe-token update-default-account-state 8Sqz2zV8TFTnkLtnCdqRkjJsre3GKRwHcZd3juE5jJHf initialized
...
```console
$ safe-token --program-id ZToGWcF1Qh9H7te1MmABiGsFUKvj5zXPQ2QnTqoHpHN create-token
Creating token CZxztd7SEZWxg6B9PH5xa7QwKpMCpWBJiTLftw1o3qyV under program ZToGWcF1Qh9H7te1MmABiGsFUKvj5zXPQ2QnTqoHpHN
...
$ safecoin-keygen new -o account.json
$ safe-token create-account CZxztd7SEZWxg6B9PH5xa7QwKpMCpWBJiTLftw1o3qyV account.json --immutable
...
```console
$ safe-token create-account CZxztd7SEZWxg6B9PH5xa7QwKpMCpWBJiTLftw1o3qyV
...
```console
$ safe-token create-account CZxztd7SEZWxg6B9PH5xa7QwKpMCpWBJiTLftw1o3qyV --immutable
Creating account 4nvfLgYMERdNbbf1pADUSp44XukAyjeWWXCMkM1gMqC4
...
```console
$ safe-token --program-id ZToGWcF1Qh9H7te1MmABiGsFUKvj5zXPQ2QnTqoHpHN create-token --enable-non-transferable
Creating token 7De7wwkvNLPXpShbPDeRCLukb3CRzCNcC3iUuHtD6k4f under program ZToGWcF1Qh9H7te1MmABiGsFUKvj5zXPQ2QnTqoHpHN
...
```console
$ safe-token --program-id ZToGWcF1Qh9H7te1MmABiGsFUKvj5zXPQ2QnTqoHpHN create-token
Creating token EbPBt3XkCb9trcV4c8fidhrvoeURbDbW87Acustzyi8N under program ZToGWcF1Qh9H7te1MmABiGsFUKvj5zXPQ2QnTqoHpHN
...
$ safe-token create-account EbPBt3XkCb9trcV4c8fidhrvoeURbDbW87Acustzyi8N
...
$ safe-token enable-required-transfer-memos 4Uzz67txwYbfYpF8r5UGEMYJwhPAYQ5eFUY89KTYc2bL
...
```console
$ safe-token disable-required-transfer-memos 4Uzz67txwYbfYpF8r5UGEMYJwhPAYQ5eFUY89KTYc2bL
...
```console
$ safe-token --program-id ZToGWcF1Qh9H7te1MmABiGsFUKvj5zXPQ2QnTqoHpHN create-token --interest-rate 10
Creating token 7N4HggYEJAtCLJdnHGCtFqfxcB5rhQCsQTze3ftYstVj under program ZToGWcF1Qh9H7te1MmABiGsFUKvj5zXPQ2QnTqoHpHN
...
import { createInterestBearingMint, updateRateInterestBearingMint, TOKEN_2022_PROGRAM_ID } from '@safecoin/safe-token';
...
```console
$ safe-token set-interest-rate 7N4HggYEJAtCLJdnHGCtFqfxcB5rhQCsQTze3ftYstVj 50
