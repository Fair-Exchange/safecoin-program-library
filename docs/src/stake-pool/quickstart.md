...
This operation costs 0.00328288 SAFE per validator. This amount is totally recoverable
by removing the validator from the stake pool.

## Step 3: Deposit into the pool

Now that your pool has validators, it needs some SAFE or stake accounts for you
...
Now there will be some SAFE for us to work with.
