...
| All | 2.0.0 | `SWPUnynS7FHA1koTbvmRktQgCDs7Tf4RkqwH19e2qSP` | `HfoTxFR1Tm6kGmWgYWD6J7YHVy1UwqSULUGVLXkJqaKN` |

The Token Swap Program was deployed to all networks by the Serum team at
`SWPUnynS7FHA1koTbvmRktQgCDs7Tf4RkqwH19e2qSP`, requiring a fee owner of
...
other AMM project on Safecoin. Almost all of these were based on Token Swap!

Check out
[program repository](https://github.com/fair-exchange/safecoin-program-library/tree/master/token-swap)
...
[JavaScript
bindings](https://github.com/fair-exchange/safecoin-program-library/blob/master/token-swap/js/src/index.ts)
...
[end-to-end tests](https://github.com/fair-exchange/safecoin-program-library/blob/master/token-swap/js/cli/token-swap-test.ts).
...
that implements the
[CurveCalculator](https://github.com/fair-exchange/safecoin-program-library/blob/master/token-swap/program/src/curve/calculator.rs)
...
curve](https://github.com/fair-exchange/safecoin-program-library/blob/master/token-swap/program/src/curve/constant_product.rs)
...
The [constant price curve](https://github.com/fair-exchange/safecoin-program-library/blob/master/token-swap/program/src/curve/constant_price.rs)
...
The [stable curve](https://github.com/fair-exchange/safecoin-program-library/blob/master/token-swap/program/src/curve/stable.rs)
...
The [offset curve](https://github.com/fair-exchange/safecoin-program-library/blob/master/token-swap/program/src/curve/offset.rs)
...
[curves](https://github.com/fair-exchange/safecoin-program-library/blob/master/token-swap/program/src/curve/constant_product.rs)
and
[math](https://github.com/fair-exchange/safecoin-program-library/blob/master/token-swap/program/src/curve/math.rs)
...
tests](https://github.com/fair-exchange/safecoin-program-library/blob/master/token-swap/program/fuzz/src/instructions.rs)
of the repo.
