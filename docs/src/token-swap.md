...
| --- | --- |
| Token Swap Program | `SWPUnynS7FHA1koTbvmRktQgCDs7Tf4RkqwH19e2qSP` |
...
[JavaScript
bindings](https://github.com/fair-exchange/safecoin-program-library/blob/master/token-swap/js/client/token-swap.js)
...
[end-to-end tests](https://github.com/fair-exchange/safecoin-program-library/blob/master/token-swap/js/cli/token-swap-test.js).
