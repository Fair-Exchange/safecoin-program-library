...
instruction returned by [create_associated_token_account](https://docs.rs/safe-associated-token-account/latest/safe_associated_token_account/fn.create_associated_token_account.html).
