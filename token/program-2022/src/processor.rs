...
impl Processor {
    ...
    pub fn process_amount_to_ui_amount(accounts: &[AccountInfo], amount: u64) -> ProgramResult {
        ...
        let ui_amount = safe_token::amount_to_ui_amount_string_trimmed(amount, mint.base.decimals);
    ...
    pub fn process_ui_amount_to_amount(accounts: &[AccountInfo], ui_amount: &str) -> ProgramResult {
        ...
        // TODO: update this with interest-bearing token extension logic
        let amount =
            safe_token::try_ui_amount_into_amount(ui_amount.to_string(), mint.base.decimals)?;
...
mod tests {
    ...
    fn native_mint() -> SafecoinAccount {
        let mut rent_sysvar = rent_sysvar();
        let mut mint_account =
            SafecoinAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &crate::id());
    ...
    fn test_owner_close_account_dups() {
        ...
        let mut to_close_account = SafecoinAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
        ...
        let mut destination_account = SafecoinAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
    ...
    fn test_get_account_data_size() {
        ...
        let mut extended_mint_account = SafecoinAccount::new(
        ...
        // Invalid mint
        let mut invalid_mint_account = SafecoinAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
