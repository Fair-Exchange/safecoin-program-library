...
mod tests {
    ...
    fn test_burn_and_close_system_and_incinerator_tokens() {
        ...
        let mut incinerator_account = SafecoinAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
        let system_account_key = Pubkey::new_unique();
        let mut system_account = SafecoinAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
        ...
        let mut recipient_account = SafecoinAccount::default();
        let mut mock_incinerator_account = SafecoinAccount::default();
        let mint_key = Pubkey::new_unique();
        let mut mint_account =
            SafecoinAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &program_id);
