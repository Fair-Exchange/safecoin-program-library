...
impl Processor {
    ...
    /// Processes [SetStakeDepositAuthority/SetSafeDepositAuthority](enum.Instruction.html).
    fn process_set_deposit_authority(
        ...
        match deposit_type {
            ...
            DepositType::Safe => stake_pool.sol_deposit_authority = new_sol_deposit_authority,
        }
        stake_pool.serialize(&mut *stake_pool_info.data.borrow_mut())?;
        Ok(())
    }
