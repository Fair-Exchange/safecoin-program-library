...
# Withdrawal fee for SAFE and stake accounts, represented as `numerator / denominator`
command_args+=( --withdrawal-fee-numerator 2 )
command_args+=( --withdrawal-fee-denominator 100 )

# Deposit fee for SAFE and stake accounts, represented as `numerator / denominator`
