use {
    ...
    safecoin_sdk::native_token::Safe,
    safecoin_sdk::{pubkey::Pubkey, stake::state::Lockup},
...
impl Display for CliStakePoolDetails {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        writeln!(
            ...
            Safe(self.reserve_stake_lamports - self.minimum_reserve_stake_balance),
        )?;
        for stake_account in &self.stake_accounts {
            writeln!(
                ...
                Safe(stake_account.validator_lamports),
    ...
    fn write_str(&self, w: &mut dyn Write) -> Result {
        ...
        for stake_account in &self.stake_accounts {
            writeln!(
                ...
                Safe(stake_account.validator_active_stake_lamports),
                stake_account.validator_transient_stake_account_address,
                Safe(stake_account.validator_transient_stake_lamports),
                stake_account.validator_last_update_epoch,
