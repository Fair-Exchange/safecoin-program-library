...
import { Lockup, PublicKey } from '@safecoin/web3.js';
import { AccountInfo } from '@safecoin/safe-token';
...
/**
 * AccountLayout.encode from "@safecoin/safe-token" doesn't work
 */
...
export interface StakePool {
  ...
  nextSafeWithdrawalFee?: Fee | undefined;
...
export const StakePoolLayout = struct<StakePool>([
  ...
  option(struct(feeFields), 'nextSafeWithdrawalFee'),
