import { AccountInfo, LAMPORTS_PER_SAFE, PublicKey, StakeProgram } from '@safecoin/web3.js';
...
export const stakePoolMock = {
  ...
  totalLamports: new BN(LAMPORTS_PER_SAFE * 999),
  poolTokenSupply: new BN(LAMPORTS_PER_SAFE * 100),
...
export const validatorListMock = {
  ...
  validators: <ValidatorStakeInfo[]>[
    ...
    },
    {
      ...
      lastUpdateEpoch: new BN('c3', 'hex'),
      activeStakeLamports: new BN(LAMPORTS_PER_SAFE * 100),
